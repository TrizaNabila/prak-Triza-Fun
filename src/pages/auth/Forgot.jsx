...
export default function Forgot() {
  ...
  return (
    <div>
      ...
      {sent ? (
        <div className="bg-pink-50 border border-pink-200 p-4 rounded-xl text-center text-sm text-pink-700">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-pink-300 transition placeholder-gray-400"
